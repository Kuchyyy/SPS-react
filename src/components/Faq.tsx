        ...
        <div className="flex flex-col lg:flex-row justify-between gap-10 relative z-10">
          ...
          <div className="flex-1 flex flex-col gap-4 items-start text-left font-robert-medium">
            {faqs.map((faq, index) => (
              <div
                key={index}
                className="border-b border-b-blue-900 shadow-sm"
              >
                <button
                  className="w-full flex justify-between gap-2.5 items-start md:px-3 py-4 text-left text-lg font-medium text-white"
                ...
                <div
                  className={`md:px-3 pb-4 text-gray-300 transition-all duration-700 ease-in-out ${
                    openIndex === index
